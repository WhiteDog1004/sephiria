...
export const PrivacyClientPage = () => {
	...
	return (
		<Column className="gap-4 p-8 m-8">
			...
			<Typography variant="header3">2. 개인정보의 수집 및 이용 목적</Typography>
			<Typography variant={contentVariant} color={contentStyles}>
			...
			<Typography variant="header3">6. 이용자의 권리와 그 행사 방법</Typography>
			<Typography variant={contentVariant} color={contentStyles}>
				- 이용자는 언제든지 자신의 개인정보에 대해 열람, 수정, 삭제를 요청할 수
				있습니다.
				<br />- Discord 로그인 계정 정보 수정은 Discord 플랫폼을 통해 직접 변경
				가능합니다.
			</Typography>
