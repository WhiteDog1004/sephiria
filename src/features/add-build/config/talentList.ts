...
export const TALENT_STATUS: TalentStatusMap = {
	anger: {
		...
		stat: {
			...
			20: "대상에게 치명타 피해를 가할 때 자신의 가장 높은 속성 피해량의 60%만큼 추가 속성 공격을 가합니다. (쿨다운 0.6초)",
		},
	},
	rapid: {
		level: {
		...
		stat: {
			...
			10: "대시 회복 속도가 +20% 증가합니다. 최종 무기공격력이 +8% 증가합니다.",
			20: "대시 중 무적 시간 보너스가 +0.1s 연장되고, 최종 무기공격력이 +15% 증가합니다.",
		},
	},
	survival: {
		level: {
